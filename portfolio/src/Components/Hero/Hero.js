    ...
    <section className="hero">
      <article className="hero-container">
        <div className="about-me">
          ...
          <div className="about-me--whatiam">
            I’m a <span className="orangize">computer engineering</span> student
          </div>
      ...
      <article className="description">
          ...
          <ul className="icon-container--list">
            <li>
              <a href="https://github.com/erickcm2k" target="_blank">
                <i class="fab fa-github fa-3x px-md-1"></i>
              </a>
            </li>
            <li>
              <a
                ...
                target="_blank"
              >
                <i class="fab fa-linkedin-in fa-3x px-md-1"></i>
              </a>
            </li>
            <li>
              <a href="https://telegram.me/erickcm2k" target="_blank">
                <i class="fab fa-telegram fa-3x px-md-1"></i>
              </a>
            </li>
          </ul>
        </div>
        <div className="message">
          ...
          <p>Currently learning how to build web apps using the <span className="nodeish">ME</span><span className="reactish">R</span><span className="nodeish">N</span> stack</p>
        </div>
      </article>
    </section>
  );
